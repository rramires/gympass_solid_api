  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://docker:docker123@localhost:5432/gympass-db?schema=public"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client\"\n  output   = \"../src/prisma-client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id            String   @id @default(uuid())\n  name          String\n  email         String   @unique\n  password_hash String\n  created_at    DateTime @default(now())\n\n  checkIns CheckIn[]\n\n  @@map(\"users\")\n}\n\nmodel CheckIn {\n  id           String    @id @default(uuid())\n  created_at   DateTime  @default(now())\n  validated_ad DateTime?\n\n  user    User   @relation(fields: [user_id], references: [id])\n  user_id String\n\n  gyn    Gym    @relation(fields: [gym_id], references: [id])\n  gym_id String\n\n  @@map(\"check_ins\")\n}\n\nmodel Gym {\n  id          String  @id @default(uuid())\n  title       String\n  description String?\n  phone       String?\n  latitude    Decimal\n  longitude   Decimal\n\n  checkIns CheckIn[]\n\n  @@map(\"gyms\")\n}\n",
  "inlineSchemaHash": "1c5881c46a01032be94a81836d5e14c314e92384eff1357b2a9162e96558bbf4",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
